    ...
    <div class="card-body">
      ...
      <div class="row" v-if="thread.thread_image_path != ''">
        <div class="thread-thumbnail card-m-5 " :style="threadThumbStyle" @click="openThreadUrl">
          ...
          <img title="" v-lazy-load :data-src="thread.thread_image_path" :alt="stripTagTitle"
            class="thread-image thread_thumb_image" heigh="120" width="auto" style="width:auto;height:120px">
        </div>
      </div>
